      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 w-full items-end">
        <div className="flex flex-col gap-6">
          ...
          <p className="text-white/60 font-mono text-[9px] md:text-[10px]">
            &copy; {new Date().getFullYear()} AJAYKUMAR K. All rights reserved.
          </p>
        </div>
        
        <div className="flex flex-col gap-1 md:items-center">
          <a href="mailto:ajaykumar348448@gmail.com" className="underline hover:text-white transition-colors underline-offset-4 decoration-1 lowercase">ajaykumar348448@gmail.com</a>
          <a href="tel:+917904332133" className="hover:text-white transition-colors mt-2" aria-label="Call Me" title="Call Me">
        ...
        <div className="flex flex-col gap-1 md:items-end">
          <p className="text-white/60">Tiruppur, Tamil Nadu</p>
        </div>
      </div>
    </footer>
  );
