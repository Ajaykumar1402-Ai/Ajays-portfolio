  ...
  const skillsData = [
    {
      ...
      description: 'Building modern intelligent algorithms, deep learning models, and NLP systems.',
    ...
    },
    {
      ...
      description: 'Image processing, classification, and real-time object detection.',
    ...
    },
    {
      ...
      description: 'Programming languages for algorithms, machine learning, and web development.',
      skills: ['Python', 'C Programming', 'HTML', 'CSS', 'JavaScript'],
      colSpan: 'md:col-span-2 lg:col-span-1',
      bgColor: 'bg-purple-50/60',
      borderColor: 'border-purple-100',
    },
    {
      category: 'Data, Databases & DevOps',
      description: 'Data analytics tools, vector databases, API deployment, and UI design.',
      skills: ['MySQL', 'ChromaDB', 'Pinecone', 'Pandas', 'NumPy', 'Git & GitHub', 'FastAPI', 'Docker', 'LiveKit', 'Research Writing', 'Matplotlib', 'GSAP', 'Framer Motion'],
      colSpan: 'md:col-span-2 lg:col-span-2',
