...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            >
              AJAYKUMAR <span className="text-[#ff2a2a]">.</span>
            </a>
          </div>
          ...
          {/* Right Side: GitHub Icon and Contact Button */}
          <div className="hidden md:flex items-center space-x-5">
            <a 
              href="https://github.com/Ajaykumar1402-Ai" 
              target="_blank" 
            ...
            <button 
              ...
              className={`px-5 py-2 rounded-full text-sm cursor-pointer transition-all duration-500 border ${
                isScrolled
        ...
        >
          <div className="flex flex-col px-6 space-y-4">
            ...
            <div className="pt-2 flex flex-col gap-4">
               <button 
                 type="button"
                 onClick={() => { setIsOpen(false); setIsResumeOpen(true); }}
                 className="inline-block px-6 py-3 rounded-full border border-white/50 text-white  hover:bg-white hover:text-[#ff2a2a] transition-all duration-300 w-full text-center cursor-pointer"
               >
      ...
      {/* Resume PDF Viewer Modal with Download Option */}
      <ResumeModal 
        isOpen={isResumeOpen} 
